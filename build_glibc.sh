...
SOURCE_DIR=$(pwd)
PROJ=$(basename $(pwd))
# Verify we are in a valid directory of glibc source
if [ ! -d stdio-common -a ! -f configure ]
then
    echo "'${PROJ}' does not appear to be a glibc source dir"
    exit 1
fi
cd ..
...
# ${DEBUG} ${SOURCE_DIR}/configure -prefix=$HOME/
# ${DEBUG} make -j${MAXCPU}
# exit $?
...
echo ""
echo "============================================================"
echo kwinject ${SOURCE_DIR}/configure -prefix=$HOME/
echo "============================================================"
${DEBUG} kwinject ${SOURCE_DIR}/configure -prefix=$HOME/
echo ""
echo "============================================================"
